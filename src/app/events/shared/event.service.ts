...
export class EventService {
  ...
  //Finds sessions by search term
  searchSessions(searchTerm: string) {
    var term = searchTerm.toLocaleLowerCase();
    var results: ISession[] = [];


    //filters and runs through all sessions assigning and id by the event id 
    ...
    // mimmicks http request as the component is an observeable so needs to return an observable 
